...
public class SinglePrefixWithViolationExplanation extends SinglePrefixBase{
	public SinglePrefixWithViolationExplanation(String prefix, HashMap<Integer, ArrayList<SingleSequenceBase>> originalSeqs,
												int maxLength) {
	...
	public void findFrequentSequences(InputSequence inputSequence,
									  ...
									  LocalParameterSpace localParameterSpace, HashMap<String, ArrayList<String>> violationCandidatesCurrentLen,
